...
namespace lve {
    ...
    void PointLightSystem::update(FrameInfo &frameInfo, GlobalUbo &ubo) {
        const auto rotateLight = glm::rotate(glm::mat4(1.f), C_F(0.5f * frameInfo.frameTime), {0.f, -1.f, 0.f});
        int lightIndex = 0;
        for(auto &[_ /*key*/, obj] : frameInfo.gameObjects) {
    ...
    void PointLightSystem::render(FrameInfo &frameInfo) {
        ...
        for(const auto &[_ /*key*/, obj] : frameInfo.gameObjects) {
            if(obj.pointLight == nullptr) continue;
